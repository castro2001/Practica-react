...
export const Header = (props: IActionSideBar)=>{
  ...
  const modalUsuarios: IActionsModal={
    ...
    return(
        <>
    <header className={`flex-shrink-0 flex items-center justify-between h-18 px-4 shadow-sm  bg-gradient-to-br bg-white fixed dark:bg-gray-800 w-full z-30 top-0 transition-all duration-300 ease-in-out `}
    style={{
            paddingLeft: sidebarOpen ? '10px' : '15px',
            paddingRight: sidebarOpen ? '280px' : '72px'
        }}
    >
