  ...
  <div className="flex items-center space-x-4">
      ...
      <div className="hidden md:flex items-center space-x-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-gray-800 font-medium truncate mb-1 dark:text-gray-50">{email}</p>
           <span className="text-gray-600 text-sm truncate dark:text-gray-50">{formatearFecha( creationAt)}</span> 
        </div>
